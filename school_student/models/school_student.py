...
class school_student(models.Model):
    ...
    #     return self.env.ref("custom_header_footer_pdf.school_student_profile_report_action").report_action(self)

    def get_custom_vals_by_email_template(self):
        return self.age
    ...
    def google_button_method(self):
        return {
            'type':'ir.actions.act_url',
            'url':'https://www.google.com',
            #'target':'self' # o default é 'new' para abrir em uma nova aba.
        }
